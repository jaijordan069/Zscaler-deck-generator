...
with tab1:
    ...
    today_date = col2.text_input("Today's Date (DD/MM/YYYY) *", value="18/11/2025", key="today_date_trans")
    project_start = col3.text_input("Project Start Date (DD/MM/YYYY) *", value="01/06/2025", key="project_start_trans")
    project_end = st.text_input("Project End Date (DD/MM/YYYY) *", value="18/11/2025", key="project_end_trans")
    project_summary_text = st.text_area("Project Summary Text",
        ...
        key="project_summary_text_trans")
    ...
    milestone_defaults = [
        ...
        {"name": "Production Rollout Complete", "baseline": "18/11/2025", "target": "??", "status": ""},
        {"name": "Final Design Accepted", "baseline": "18/11/2025", "target": "18/11/2025", "status": ""}
    ]
    for i in range(7):
    ...
    with col_p1:
        ...
        pilot_completion = st.text_input("Pilot Completion Date", value="18/11/2025")
    ...
    with col_p2:
        ...
        prod_completion = st.text_input("Production Completion Date", value="18/11/2025")
