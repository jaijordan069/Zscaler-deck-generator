...
st.markdown("Fill form → Preview → Generate → Download")

def is_valid_date(s):
    return bool(re.match(r'^\d{2}/\d{2}/\d{4}$', s))

# FORM (shortened for brevity, add your form code here from previous messages)

# === HELPER: Header / Footer / Number (defined EARLY) ===
